 ...
 */
package len.ros.bridge.rosbridge;

import len.ros.bridge.ROSClient;
import len.ros.bridge.Service;
import len.ros.bridge.message.Message;
import len.ros.bridge.message.MessageType;
import len.ros.bridge.rosapi.message.*;
import len.ros.bridge.rosbridge.implementation.ROSBridgeWebSocketClient;
import len.ros.bridge.rosbridge.operation.Operation;
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<len.ros.bridge.rosapi.message.Service, Type> serviceTypeService =
                new Service<len.ros.bridge.rosapi.message.Service, Type>("/rosapi/service_type",
                        len.ros.bridge.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new len.ros.bridge.rosapi.message.Service(service)).type;
    }
